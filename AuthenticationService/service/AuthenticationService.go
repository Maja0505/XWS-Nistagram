...
func (service *AuthenticationService)  CreateToken(userid uint64) (*model.TokenDetails, error) {
	fmt.Println("Zapoceto kreiranje tokena.....")
...
func (service *AuthenticationService) ExtractTokenMetadata(r *http.Request) (*model.AccessDetails, error) {
	token, err := service.VerifyToken(r)
	if err != nil {
		return nil, err
	}
